...
const arrayTronsformed=arrayNum.map((currentValue)=>{
     return currentValue*currentValue;
})
console.log(arrayTronsformed);
class Student {
...
console.log(`==================WAP to get name of all object================`);
const arrauOfname=arrayStudents.map((element)=>{
    return element.name;
})
console.log(arrauOfname);
