...
console.log(`============WAP to find the students whose ID is ODD and find its average marks=======`);
...
console.log(`Total marks is:${sumOfMarks},and number of students with odd is ${array.length}`);
